...
public class RefundPolicyDTO {
    ...
    public RefundPolicyDTO(boolean isRefundable, int refundTimeInDays, List<String> notes) {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == com.m2iii.mapperbench.model.source.RefundPolicy.class) {
            com.m2iii.mapperbench.model.source.RefundPolicy that = (com.m2iii.mapperbench.model.source.RefundPolicy) o;
            return isRefundable == that.isRefundable() &&
                    refundTimeInDays == that.getRefundTimeInDays() &&
                    Objects.equal(notes, that.getNotes());
        }
        if (o.getClass() != getClass()) return false;
        RefundPolicyDTO that = (RefundPolicyDTO) o;
        return isRefundable == that.isRefundable &&
