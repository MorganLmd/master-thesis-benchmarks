...
public class DeliveryDataDTO {
    ...
    public DeliveryDataDTO(AddressDTO deliveryAddress, boolean isPrePaid, String trackingCode, int expectedDeliveryTimeInDays) {
        this.deliveryAddress = deliveryAddress;
    ...
    public boolean equals(Object o) {
        ...
        if(o.getClass() == com.m2iii.mapperbench.model.source.DeliveryData.class) {
            com.m2iii.mapperbench.model.source.DeliveryData deliveryData =
                    (com.m2iii.mapperbench.model.source.DeliveryData) o;
        ...
        DeliveryDataDTO that = (DeliveryDataDTO) o;
